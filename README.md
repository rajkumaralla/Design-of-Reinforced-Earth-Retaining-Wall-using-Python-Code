...
Vertical line load condition. 

The code will take input parameters such as soil properties, wall 
geometry, and loads, and will output the reinforcement requirements & factor of safety against 
rupture and pullout resistance. 

The developed code will be validated against existing design 
